"""Visita pública de Tres Arroyos; comprueba la interfaz, no sólo una respuesta HTTP.
...
APP_URL = "https://d67etg87zvgftlgckazzw6.streamlit.app/"
HEADING = "Gemelo Digital · Lolium Tres Arroyos"
            ...
            while time.monotonic() - started < MAX_WAIT_SECONDS:
                ...
                if ready:
                    if ready_since is None:
                        ...
                        return f"Tres Arroyos operativo: indicadores y gráfico cargados ({seconds} s)."
                else:
                    ready_since = None
