...
def build_calibration(observations_path, weather_path, output_path, site="Tres Arroyos",
                      coverage=20.0, w_max=18.81, source_metadata_path=None):
    ...
    validation = {
        ...
        "note": (
            ...
            "Se utiliza meteorología SIGA observada y ECMWF provisional, "
...
def main():
    ...
    parser.add_argument("--observations", type=Path, default=ROOT / "data/calibration/tres_arroyos_2026_counts.csv")
    parser.add_argument("--weather", type=Path, default=ROOT / "data/calibration/tres_arroyos_2026_weather.csv")
    parser.add_argument("--output", type=Path, default=ROOT / "data/calibration/tres_arroyos_2026.json")
    parser.add_argument("--source-metadata", type=Path, default=ROOT / "data/calibration/tres_arroyos_2026_source.json")
    parser.add_argument("--site", default="Tres Arroyos")
