...
spec = importlib.util.spec_from_file_location(
    "tres_arroyos_original", ROOT / "tests/fixtures/tres_arroyos_original.py"
)
original = importlib.util.module_from_spec(spec)
spec.loader.exec_module(original)


@pytest.mark.parametrize("coverage,wmax,kr", [(20, 18.81, 0), (10, 10, 0), (60, 36, 1), (100, 5, 0)])
def test_extracted_core_matches_original_tres_arroyos(coverage, wmax, kr):
    ...
    expected, _, _, _ = original.simular_emergencia_ta(
...
def test_tres_arroyos_april_decay_preserves_early_flow_and_caps_late_flow():
...
def test_real_tres_arroyos_run_has_expected_invariants():
