"""Núcleo biofísico de PREDWEEM Tres Arroyos vK4.9.15 Visual V3.

Conserva las entradas ANN, los filtros y el techo decreciente desde el 15 de
abril de loliumTA_2026. La normalización parcial y la cobertura diaria
...
def calculate_et0_hargreaves(jday, tmax, tmin, latitude=-38.4500):
...
def apply_cohort_decay(
    ...
    """Conserva el techo original de Tres Arroyos desde el 15/04 de cada año.
